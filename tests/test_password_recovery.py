...
class TestPasswordRecovery:
    ...
    def test_recovery_password_page_open(self, driver):
        ...
        assert password_recovery_page.wait_and_find_element(PasswordRecoveryPageLocators.ENTER_EMAIL_FIELD).is_displayed() and password_recovery_page.get_current_url(driver) == Urls.RECOVERY_PASSWORD
    ...
    def test_enter_email_and_submit_button(self, driver):
        ...
        time.sleep(1)
        assert password_recovery_page.wait_and_find_element(PasswordRecoveryPageLocators.ENTER_PASSWORD_FIELD).is_displayed() and password_recovery_page.get_current_url(driver) == Urls.RESET_PASSWORD
